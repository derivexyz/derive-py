...
class VaultOperations:
    ...
    async def get(self, *, vault_subaccount_id: Optional[int] = None) -> Vault:
        """
        ...
        result = await self._subaccount._public_api.rpc.get_vault(params)
        return result
    ...
    async def action_history(
        ...
        *,
        ...
        result = await self._subaccount._public_api.rpc.get_vault_action_history(params)
        return result
    ...
    async def performance_history(
        ...
        *,
        ...
        result = await self._subaccount._public_api.rpc.get_vault_performance_history(params)
        return result
    ...
    async def list_curated(self) -> VaultIdsResponse:
        ...
        result = await self._subaccount._private_api.rpc.get_curated_vaults(params)
        return result

    async def list_shareholdings(self) -> VaultIdsResponse:
        ...
        result = await self._subaccount._private_api.rpc.get_shareholder_vaults(params)
        return result

    async def shares(self) -> VaultSharesResponse:
        ...
        result = await self._subaccount._private_api.rpc.get_vault_shares(params)
        return result

    async def list_live_requests(self) -> MultipleVaultRequestsResponse:
        ...
        result = await self._subaccount._private_api.rpc.get_live_vault_requests(params)
        return result
    ...
    async def request_history(
        ...
        *,
        ...
        result = await self._subaccount._private_api.rpc.get_vault_request_history(params)
        return result
    ...
    async def request_deposit(
        ...
        *,
        ...
        result = await self._subaccount._private_api.rpc.request_vault_deposit(params)
        return result
    ...
    async def request_withdraw(
        ...
        *,
        ...
        result = await self._subaccount._private_api.rpc.request_vault_withdraw(params)
        return result
    ...
    async def cancel_all_requests(
        ...
        *,
        ...
        result = await self._subaccount._private_api.rpc.cancel_all_vault_requests(params)
        return result
    ...
    async def create(
        ...
        *,
        ...
        result = await self._subaccount._private_api.rpc.create_vault(params)
        return result
    ...
    async def list_live_mint_requests(
        self,
        *,
        limit: int = 100,
        vault_subaccount_id: Optional[int] = None,
        ...
        result = await self._subaccount._private_api.rpc.get_live_mint_requests(params)
        return result

    async def list_live_burn_requests(
        self,
        *,
        limit: int = 100,
        vault_subaccount_id: Optional[int] = None,
        ...
        result = await self._subaccount._private_api.rpc.get_live_burn_requests(params)
        return result
    ...
    async def mint_shares(
        ...
        *,
        ...
        result = await self._subaccount._private_api.rpc.mint_vault_shares(params)
        return result
    ...
    async def update_info(
        ...
        *,
        ...
        result = await self._subaccount._private_api.rpc.update_vault_info(params)
        return result
