...
class HistoryOperations:
    ...
    async def deposits(
        ...
        result = await self._private_api.rpc.get_deposit_history(params)
        return result
    ...
    async def withdrawals(
        ...
        result = await self._private_api.rpc.get_withdrawal_history(params)
        return result
    ...
    async def erc20_transfers(
        ...
        result = await self._private_api.rpc.get_erc20_transfer_history(params)
        return result
    ...
    async def interest(
        ...
        result = await self._private_api.rpc.get_interest_history(params)
        return result

    async def option_settlements(self) -> OptionSettlementHistoryResponse:
        ...
        result = await self._private_api.rpc.get_option_settlement_history(params)
        return result
    ...
    async def funding(
        ...
        result = await self._private_api.rpc.get_funding_history(params)
        return result
    ...
    async def orders(
        ...
        result = await self._private_api.rpc.get_order_history(params)
        return result
    ...
    async def trades(
        ...
        result = await self._private_api.rpc.get_trade_history(params)
        return result
