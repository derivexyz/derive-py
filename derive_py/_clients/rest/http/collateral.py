...
class CollateralOperations:
    ...
    def _resolve_asset_address(self, *, asset_name: str) -> ChecksumAddress:
        ...
        risk_universes = self._subaccount.markets._risk_universes_cache or self._subaccount.markets.get_risk_universes()
    ...
    def transfer_spot(
        ...
        *,
        ...
        asset_address = self._resolve_asset_address(asset_name=asset_name)
