...
class CollateralOperations:
    ...
    async def get(self) -> PrivateGetCollateralsResponse:
    ...
    async def transfer_spot(
        ...
        *,
        ...
        result = await self._subaccount._private_api.rpc.transfer_spot(params)
        return result
    ...
    async def transfer_spot_external(
        ...
        *,
        ...
        result = await self._subaccount._private_api.rpc.transfer_spot_external(params)
        return result
